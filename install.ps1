<#
.SYNOPSIS
    Install AKSARA — P2P encrypted terminal chat (Windows x64)
.DESCRIPTION
...
$repo      = "0xAre/aksara"
$assetName = "aksara-x86_64-pc-windows-msvc.exe"
$installDir = "$env:LOCALAPPDATA\Programs\aksara"
$binary    = "aksara.exe"
...
Write-Host ""
Write-Host " AKSARA Installer" -ForegroundColor White
Write-Host " ================" -ForegroundColor DarkGray
Write-Host ""

# Tentukan versi yang akan diinstall
if ($env:AKSARA_VERSION) {
    $version = $env:AKSARA_VERSION.TrimStart("v")
...
Write-Host "   aksara" -ForegroundColor White
Write-Host ""
