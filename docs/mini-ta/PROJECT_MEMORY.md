...
- **Yang tersisa sebelum penyusunan DOCX, seluruhnya butuh tindakan pengguna**: nama 3 anggota/prodi/institusi, persetujuan judul (`09_SCOPE_AND_TEAM_PLAN.md` §7 merekomendasikan Judul #3), capture screenshot TUI, dan **ekstraksi aturan format dari `00-template/Cetak TA_rev3.docx`** (template ada, spesifikasi format untuk Codex belum pernah dibuat).
