...
| 12 | Screenshot aplikasi | ✅ DONE (penuh, sejak 2026-07-30) | Output: `screenshots/STATUS.md`. `cargo build --release` sukses (0 warning/error, commit `450d484`, aksara v0.2.1, binary 8,77MB). Verifikasi fungsi non-interaktif via `aksara id --offline`: generate identitas, unseal deterministik (invite/fingerprint identik), reject passphrase salah ("vault could not be opened") — seluruhnya cocok dokumentasi TAHAP 6/7. Screenshot TUI aktual: Sesi A (5 berkas, 2026-07-29) dan Sesi B/Tor (6 berkas, 2026-07-30) seluruhnya sudah masuk repo — tidak ada lagi item tertunda. |
