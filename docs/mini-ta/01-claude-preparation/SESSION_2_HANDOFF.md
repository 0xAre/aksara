...
3. **Penomoran file TAHAP 5+ SUDAH DIPUTUSKAN** (digeser +2, lihat `PROGRESS.md` §0 Keputusan Penting untuk pemetaan lengkap) — TAHAP 5 memakai `06_PROTOCOL_SPECIFICATION.md`, TAHAP 6 `07_KEY_LIFECYCLE.md`, TAHAP 7 `08_THREAT_MODEL.md`, dst. Jangan menomori ulang dari nol dan jangan pakai nama file di `CLAUDE_PREPARATION_BRIEF.md` secara literal.
